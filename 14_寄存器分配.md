...
<figure class="svg-diagram" style="--diagram-max: 900px; --diagram-min: 680px;">
  <svg class="compiler-diagram" viewBox="0 0 900 190" role="img" aria-labelledby="regalloc-input-output-title">
    <title id="regalloc-input-output-title">寄存器分配在后端流水线中的位置</title>
    <defs>
      <marker id="regalloc-input-output-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
        <path d="M0 0 L10 5 L0 10 Z" fill="#607476" />
      </marker>
    </defs>
    <rect class="node" x="24" y="34" width="150" height="46" rx="8" />
    <text x="99" y="62" text-anchor="middle">Instruction</text>
    <path class="edge" marker-end="url(#regalloc-input-output-arrow)" d="M174 57 H211" />
    <rect class="node" x="211" y="34" width="150" height="46" rx="8" />
    <text x="286" y="62" text-anchor="middle">Abstract Asm</text>
    <path class="edge" marker-end="url(#regalloc-input-output-arrow)" d="M361 57 H398" />
    <rect class="node" x="398" y="34" width="150" height="46" rx="8" />
    <text x="473" y="62" text-anchor="middle">Flow Graph</text>
    <path class="edge" marker-end="url(#regalloc-input-output-arrow)" d="M548 57 H585" />
    <rect class="node" x="585" y="34" width="150" height="46" rx="8" />
    <text x="660" y="62" text-anchor="middle">Liveness</text>
    <path class="edge" marker-end="url(#regalloc-input-output-arrow)" d="M660 80 V112" />
    <rect class="node" x="585" y="112" width="150" height="46" rx="8" />
    <text x="660" y="131" text-anchor="middle">Interference</text>
    <text x="660" y="149" text-anchor="middle" class="small">Graph</text>
    <path class="edge" marker-end="url(#regalloc-input-output-arrow)" d="M585 135 H548" />
    <rect class="node-soft" x="398" y="112" width="150" height="46" rx="8" />
    <text x="473" y="140" text-anchor="middle">Reg Allocation</text>
    <path class="edge" marker-end="url(#regalloc-input-output-arrow)" d="M398 135 H361" />
    <rect class="node-soft" x="211" y="112" width="150" height="46" rx="8" />
    <text x="286" y="140" text-anchor="middle">Final Assembly</text>
  </svg>
</figure>
...
课件补充口径：一次 simplify 中通常一次选一个 potential spill；select 阶段可能累积多个 actual spill，最终 rewrite 时可以把这些 actual spills 一起插入 load/store 后重跑分配器。如果题目明确要求“算 spill cost 后选一个马上 rewrite”，就按题目要求只处理那个节点。
...
PPT 的优化流程是一个闭环：先 `Build`，再围绕 `Simplify`、`Coalesce`、`Freeze` 和 `Potential Spill` 反复收缩图；`Select` 后如果发现 actual spill，就 rewrite code 并重新 build。

可以画成：

<figure class="svg-diagram" style="--diagram-max: 900px; --diagram-min: 700px;">
  <svg class="compiler-diagram" viewBox="0 0 900 520" role="img" aria-labelledby="irc-flow-title">
    <title id="irc-flow-title">Iterated Register Coalescing 的控制流程</title>
    <defs>
      <marker id="irc-flow-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
        <path d="M0 0 L10 5 L0 10 Z" fill="#607476" />
      </marker>
    </defs>
    <rect class="node-soft" x="320" y="24" width="260" height="54" rx="8" />
    <text x="450" y="47" text-anchor="middle" class="title">Build</text>
    <text x="450" y="65" text-anchor="middle" class="small">interference graph + move edges</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M450 78 V112" />
    <rect class="node" x="360" y="112" width="180" height="50" rx="8" />
    <text x="450" y="142" text-anchor="middle" class="title">Simplify</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M450 162 V198" />
    <path class="node-warn" d="M450 198 L565 248 L450 298 L335 248 Z" />
    <text x="450" y="243" text-anchor="middle" class="title">Can coalesce?</text>
    <text x="450" y="262" text-anchor="middle" class="small">move-related nodes</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M335 248 H190" />
    <text x="260" y="235" text-anchor="middle" class="label">yes</text>
    <rect class="node" x="70" y="223" width="120" height="50" rx="8" />
    <text x="130" y="253" text-anchor="middle" class="title">Coalesce</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M130 223 V137 H354" />
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M565 248 H650" />
    <text x="608" y="235" text-anchor="middle" class="label">no</text>
    <path class="node-warn" d="M730 198 L835 248 L730 298 L625 248 Z" />
    <text x="730" y="243" text-anchor="middle" class="title">Can freeze?</text>
    <text x="730" y="262" text-anchor="middle" class="small">low-degree move</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M730 298 V350" />
    <text x="748" y="326" class="label">yes</text>
    <rect class="node" x="670" y="350" width="120" height="50" rx="8" />
    <text x="730" y="380" text-anchor="middle" class="title">Freeze</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M670 375 H450 V168" />
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M625 248 H600 V375 H540" />
    <text x="604" y="235" text-anchor="middle" class="label">no</text>
    <rect class="node" x="360" y="350" width="180" height="50" rx="8" />
    <text x="450" y="371" text-anchor="middle" class="title">Potential Spill</text>
    <text x="450" y="389" text-anchor="middle" class="small">select candidate</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M450 350 V304" />
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M450 400 V432" />
    <rect class="node-soft" x="340" y="432" width="220" height="50" rx="8" />
    <text x="450" y="462" text-anchor="middle" class="title">Select colors</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M560 457 H650" />
    <path class="node-warn" d="M730 417 L835 457 L730 497 L625 457 Z" />
    <text x="730" y="453" text-anchor="middle" class="title">Actual spills?</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M625 457 H585" />
    <text x="605" y="444" text-anchor="middle" class="label">no</text>
    <rect class="node-soft" x="70" y="432" width="120" height="50" rx="8" />
    <text x="130" y="462" text-anchor="middle" class="title">Done</text>
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M625 457 H196" />
    <path class="edge" marker-end="url(#irc-flow-arrow)" d="M730 417 V58 H586" />
    <text x="748" y="408" class="label">yes: rewrite code</text>
  </svg>
</figure>
