...
<figure class="svg-diagram" style="--diagram-max: 760px; --diagram-min: 540px;">
  <svg class="compiler-diagram" viewBox="0 0 760 690" role="img" aria-labelledby="tiger-fig11-title">
    <title id="tiger-fig11-title">虎书 Figure 1.1 的阶段接口</title>
    <defs>
      <marker id="tiger-fig11-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
        <path d="M0 0 L10 5 L0 10 Z" fill="#607476" />
      </marker>
    </defs>
    <rect class="node-soft" x="235" y="18" width="290" height="42" rx="8" />
    <text x="380" y="45" text-anchor="middle" class="title">Source Program</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 60 V86" />
    <rect class="node" x="235" y="86" width="290" height="42" rx="8" />
    <text x="380" y="113" text-anchor="middle">Tokens</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 128 V154" />
    <rect class="node" x="235" y="154" width="290" height="42" rx="8" />
    <text x="380" y="181" text-anchor="middle">Abstract Syntax</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 196 V222" />
    <rect class="node" x="235" y="222" width="290" height="42" rx="8" />
    <text x="380" y="249" text-anchor="middle">IR Trees</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 264 V290" />
    <rect class="node" x="235" y="290" width="290" height="42" rx="8" />
    <text x="380" y="317" text-anchor="middle">Canonical IR Trees</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 332 V358" />
    <rect class="node" x="235" y="358" width="290" height="42" rx="8" />
    <text x="380" y="385" text-anchor="middle">Assem</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 400 V426" />
    <rect class="node" x="235" y="426" width="290" height="42" rx="8" />
    <text x="380" y="453" text-anchor="middle">Flow Graph</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 468 V494" />
    <rect class="node" x="235" y="494" width="290" height="42" rx="8" />
    <text x="380" y="521" text-anchor="middle">Interference Graph</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 536 V562" />
    <rect class="node" x="235" y="562" width="290" height="42" rx="8" />
    <text x="380" y="589" text-anchor="middle">Register Assignment</text>
    <path class="edge" marker-end="url(#tiger-fig11-arrow)" d="M380 604 V630" />
    <rect class="node-soft" x="235" y="630" width="290" height="42" rx="8" />
    <text x="380" y="657" text-anchor="middle">Assembly Language</text>
  </svg>
</figure>
...
<figure class="svg-diagram" style="--diagram-max: 980px; --diagram-min: 760px;">
  <svg class="compiler-diagram" viewBox="0 0 980 760" role="img" aria-labelledby="full-compiler-pipeline-title">
    <title id="full-compiler-pipeline-title">完整编译器流水线</title>
    <defs>
      <marker id="full-compiler-pipeline-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
        <path d="M0 0 L10 5 L0 10 Z" fill="#607476" />
      </marker>
    </defs>
    <rect class="node-soft" x="60" y="24" width="180" height="46" rx="8" />
    <text x="150" y="52" text-anchor="middle">Source Program</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M240 47 H294" />
    <rect class="node" x="294" y="24" width="180" height="46" rx="8" />
    <text x="384" y="52" text-anchor="middle">Lexical Analysis</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M474 47 H528" />
    <rect class="node" x="528" y="24" width="180" height="46" rx="8" />
    <text x="618" y="52" text-anchor="middle">Tokens</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M708 47 H762" />
    <rect class="node" x="762" y="24" width="160" height="46" rx="8" />
    <text x="842" y="52" text-anchor="middle">Parsing</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M842 70 V104" />
    <rect class="node" x="762" y="104" width="160" height="46" rx="8" />
    <text x="842" y="132" text-anchor="middle">AST</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M762 127 H708" />
    <rect class="node" x="528" y="104" width="180" height="46" rx="8" />
    <text x="618" y="132" text-anchor="middle">Semantic Analysis</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M618 150 V184" />
    <rect class="node-warn" x="410" y="184" width="180" height="46" rx="8" />
    <text x="500" y="202" text-anchor="middle">TEnv / VEnv</text>
    <text x="500" y="220" text-anchor="middle" class="small">Types</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M618 150 C654 172 686 181 730 188" />
    <rect class="node" x="730" y="184" width="180" height="46" rx="8" />
    <text x="820" y="212" text-anchor="middle">Translate</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M820 230 V264" />
    <rect class="node" x="730" y="264" width="180" height="46" rx="8" />
    <text x="820" y="283" text-anchor="middle">IR Tree</text>
    <text x="820" y="301" text-anchor="middle" class="small">Fragments</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M730 287 H676" />
    <rect class="node" x="496" y="264" width="180" height="46" rx="8" />
    <text x="586" y="292" text-anchor="middle">Canonicalize</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M496 287 H442" />
    <rect class="node" x="262" y="264" width="180" height="46" rx="8" />
    <text x="352" y="292" text-anchor="middle">Basic Blocks</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M262 287 H208" />
    <rect class="node" x="28" y="264" width="180" height="46" rx="8" />
    <text x="118" y="292" text-anchor="middle">Trace Scheduling</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M118 310 V344" />
    <rect class="node" x="28" y="344" width="180" height="46" rx="8" />
    <text x="118" y="372" text-anchor="middle">Instruction Selection</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M208 367 H262" />
    <rect class="node" x="262" y="344" width="180" height="46" rx="8" />
    <text x="352" y="363" text-anchor="middle">Abstract</text>
    <text x="352" y="381" text-anchor="middle" class="small">Assembly</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M442 367 H496" />
    <rect class="node" x="496" y="344" width="180" height="46" rx="8" />
    <text x="586" y="372" text-anchor="middle">Flow Graph</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M676 367 H730" />
    <rect class="node" x="730" y="344" width="180" height="46" rx="8" />
    <text x="820" y="372" text-anchor="middle">Liveness Analysis</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M820 390 V424" />
    <rect class="node" x="730" y="424" width="180" height="46" rx="8" />
    <text x="820" y="443" text-anchor="middle">Interference</text>
    <text x="820" y="461" text-anchor="middle" class="small">Graph</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M730 447 H676" />
    <rect class="node" x="496" y="424" width="180" height="46" rx="8" />
    <text x="586" y="452" text-anchor="middle">Register Allocation</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M496 447 H442" />
    <rect class="node" x="262" y="424" width="180" height="46" rx="8" />
    <text x="352" y="452" text-anchor="middle">Code Emission</text>
    <path class="edge" marker-end="url(#full-compiler-pipeline-arrow)" d="M262 447 H208" />
    <rect class="node-soft" x="28" y="424" width="180" height="46" rx="8" />
    <text x="118" y="443" text-anchor="middle">Assembly /</text>
    <text x="118" y="461" text-anchor="middle" class="small">Object Code</text>
  </svg>
</figure>
...
<figure class="svg-diagram" style="--diagram-max: 760px; --diagram-min: 560px;">
  <svg class="compiler-diagram" viewBox="0 0 760 250" role="img" aria-labelledby="variable-representation-title">
    <title id="variable-representation-title">同一个变量名在不同编译阶段的表示</title>
    <defs>
      <marker id="variable-representation-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
        <path d="M0 0 L10 5 L0 10 Z" fill="#607476" />
      </marker>
    </defs>
    <rect class="node-soft" x="28" y="78" width="120" height="54" rx="8" />
    <text x="88" y="100" text-anchor="middle" class="title">x</text>
    <text x="88" y="119" text-anchor="middle" class="small">source name</text>
    <path class="edge" marker-end="url(#variable-representation-arrow)" d="M148 105 H194" />
    <rect class="node" x="194" y="78" width="134" height="54" rx="8" />
    <text x="261" y="100" text-anchor="middle">VarEntry</text>
    <text x="261" y="119" text-anchor="middle" class="small">semantic</text>
    <path class="edge" marker-end="url(#variable-representation-arrow)" d="M328 105 H374" />
    <rect class="node" x="374" y="78" width="134" height="54" rx="8" />
    <text x="441" y="100" text-anchor="middle">access / temp</text>
    <text x="441" y="119" text-anchor="middle" class="small">translate</text>
    <path class="edge" marker-end="url(#variable-representation-arrow)" d="M508 105 H554" />
    <rect class="node" x="554" y="78" width="134" height="54" rx="8" />
    <text x="621" y="100" text-anchor="middle">temporary</text>
    <text x="621" y="119" text-anchor="middle" class="small">assembly</text>
    <path class="edge" marker-end="url(#variable-representation-arrow)" d="M621 132 V170 H441 V188" />
    <rect class="node-soft" x="348" y="188" width="186" height="44" rx="8" />
    <text x="441" y="215" text-anchor="middle">physical register</text>
    <text x="545" y="165" class="label">regalloc</text>
  </svg>
</figure>
